...
function BlogENindex() {
    const router = useRouter();
    const { data: RandomDataEN, isLoading: isLoadingRandomItemsEN } =
  ...
  return (
    ...
    <div className="w-full justify-center p-2 lg:w-4/6 lg:p-4">
      <>
        <Link href={`/blogs/${RandomDataEN?.title}`}>
          <div>
            <div className="m-auto mt-6 w-full cursor-pointer lg:w-8/12">
              <div className="">
                <div className="flex justify-between">
                  <div className="flex items-center">
                    {RandomDataEN?.author == "Mark Teekens" ? (
                      <Image
                        src="/mark.jpg"
                        alt="mark"
                        className="h-10 w-10 rounded-full object-cover lg:h-14 lg:w-14" height={600} width={600}
                      />
                    ) : (
                      <Image
                        src="/jorn.jpeg"
              ...
              <div className="mt-4 flex h-52 max-w-4xl">
                <Image
                  src={RandomDataEN?.image}
                  alt="blog_banner"
                  className="mt-4 w-full object-cover" height={600} width={600}
                />
              </div>
              ...
              <div className="flex">
                  ...
                  <div className="flex">
                    {data?.author == "Mark Teekens" ? (
                      <Image
                        src="/mark.jpg"
                        alt="mark"
                        className="h-6 w-6 rounded-full object-cover " height={600} width={600}
                      />
                    ) : (
                      <Image
                        src="/jorn.jpeg"
                ...
                <div className="w-2/6">
                  <Image
                    ...
                    className="ml-6 h-14 w-14 rounded-md object-cover " height={600} width={600}
                  />
                </div>
              </div>
            </Link>
