...
import profilePic from "../images/feature_img_1.min.png";
      ...
      {router.locale == "nl-NL" ? (
            ...
            <div className="mt-0 grid grid-cols-1 items-center justify-center lg:mt-20 lg:flex lg:grid-cols-2 ">
              <div className="w-full p-10 lg:w-5/12 lg:p-0">
                ...
                <p className="mt-2 text-lg font-semibold lg:mt-0">
                  ...
                  runnen van je bedrijf. Ons team ontlast je van de
                  administratie, zorgt voor een correcte boekhouding en is
                  bereikbaar voor al je (fiscale) vragen. Zodat jij je kan
                  focussen op het geen dat écht belangrijk is: je business
                  runnen.
                </p>
                <button
                  onClick={scrolltoId}
            ...
            <div className="">
              <div className="flex flex-col items-center justify-center pt-36">
                ...
                <div className=" mt-4  w-4/6 text-center font-normal lg:w-2/6">
                  Om het onze klanten zo makkelijk mogelijk te maken werken wij
            ...
            <div className="grid grid-cols-1 justify-center gap-20 pt-14  lg:flex">
              <div className="flex flex-col items-center gap-3 text-center">
                ...
                <p className="w-96 px-6 text-sm">
                  ...
                  offertes en facturen op, heb je overzicht van de openstaande
                  of betaalde facturen, weet je welke inkoopfacturen nog
                  verwerkt moeten worden en zie je je BTW-overzicht. Zo zijn er
                  nog meer functies die het makkelijk en overzichtelijk maken.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-4 w-96 px-6 text-sm">
                  ...
                  mogelijk belastingvoordeel toegepast wordt. Zo kun je tijdens
                  onze werkuren altijd met ons bellen over je situatie. We
                  denken graag met je mee, ook wanneer jouw vraag buiten onze
                  fiscale expertise valt.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Image
                ...
                <p className="mt-4 w-96 px-6 text-sm ">
                  ...
                  lekker als je boekhouder nog bereikbaar is wanneer je thuis
                  komt. Dan hoef je geen hele dag vrij te nemen voor
                  bijvoorbeeld een gesprek van een half uur. We zijn dan ook
                  bereikbaar op Ma. t/m Vr. tussen 10.00 en 20.00. Zelfs buiten
                  onze openingstijden doen we ons best om zo snel mogelijk te
                  reageren mits die mogelijkheid er is.
                </p>
              </div>
            </div>
            <div className="p-6">
                    ...
                    <div className="space-y-3 sm:gap-2 lg:grid lg:grid-cols-2 lg:space-y-0">
                      <div className="">
                        ...
                        <p className="mt-2 text-2xl font-semibold text-blue-700">
                          Ons bedrijf is kostenefficiënt ingericht zodat we de
                          beste prijs kunnen geven.
                        </p>
                        <p className="mt-2 pb-20 text-lg font-normal">
                          Als startende ondernemer heb je veel kosten. Daarom
                          bieden wij de volledige boekhouding met de
                          boekhoudapp, voor een vaste lage prijs met de goede
                          service van Ruby Finance.
                        </p>
                      </div>
                      <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white bg-opacity-60 p-6 text-center text-gray-900 shadow backdrop-blur-sm hover:shadow-lg xl:p-8">
                        ...
                        <ul
                          role="list"
                          className="mb-8 mt-8 space-y-4 text-left"
                        >
                ...
                <div className="mb-10 px-4 lg:mb-4 lg:px-20">
                  ...
                  <div>
                    <p className="mt-4 text-2xl">
                      Plan een gesprek om te kijken of Ruby Finance past bij
                      jouw
                    </p>
        ...
        <div>
          <div className="h-screen w-full bg-gradient-to-br from-[#496adc] to-[#c57bfe] text-white">
            ...
            <div className="mt-0 grid grid-cols-1 items-center justify-center lg:mt-20 lg:flex lg:grid-cols-2 ">
              <div className="w-full p-10 lg:w-5/12 lg:p-0">
                <h1 className="mt-8 text-2xl font-bold lg:mt-0 lg:text-6xl">
          ...
          <main className="h-full min-h-screen bg-white text-black">
            <div className="">
              <div className="flex flex-col items-center justify-center pt-36">
                ...
                <div className=" mt-4  w-4/6 text-center font-normal lg:w-2/6">
                  We work to make things as easy as possible for our customers
                  we offer an{" "}
                  <strong className="font-normal text-purple-500">
                    accounting tool
                  </strong>
            ...
            <div className="grid grid-cols-1 justify-center gap-20 pt-14 lg:flex">
              <div className="flex flex-col items-center gap-3  text-center">
                ...
                <p className="w-96 px-6 text-sm">
                  With our accounting tool, for example, you can easily set up
                  new ones quotes and invoices, you have an overview of the
                  outstanding ones or paid invoices, you know which purchase
                  invoices are still available to be processed and you will see
                  your VAT overview. For example, there are even more functions
                  that make it easy and clear.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Image
                ...
                <p className="mt-4 w-96 px-6 text-sm">
                  At Ruby Finance, we think it&apos;s important that you
                  don&apos;t spend too much tax paid. With our knowledge we
                  ensure that every possible tax benefit. So you can during our
                  working hours always call us about your situation. We are
                  happy to think along with you, even if your question is
                  outside our scope tax expertise.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                <Image
                ...
                <p className="mt-4 w-96 px-6 text-sm">
                  Since you probably work long days as a self-employed person,
                  it is nice if your bookkeeper is still available when you get
                  home coming. Then you don&apos;t have to take a whole day off
                  for it for example a conversation of half an hour. So we are
                  available on Mon. to Fri. between 10 a.m. and 8 p.m. Even
                  outside We do our best to change our opening hours as quickly
                  as possible respond if possible.
                </p>
              </div>
            </div>
            <div className="p-6">
                  ...
                  <div className="mx-auto max-w-screen-xl py-8 px-4 lg:py-16 lg:px-6">
                    <div className="space-y-3 sm:gap-2 lg:grid lg:grid-cols-2 lg:space-y-0">
                      <div className="">
                        ...
                        <p className="mt-2 text-2xl font-semibold text-blue-700">
                          Our company is set up cost-efficiently so that we can
                          can give best price.
                        </p>
                        <p className="mt-2 pb-20 text-lg font-normal">
                          As a starting entrepreneur you have a lot of costs.
                          Therefore we provide full accounting with the
                          accounting app, for a fixed low price with the right
                          one service from Ruby Finance.
                        </p>
                      </div>
                      <div className="mx-auto flex max-w-lg flex-col rounded-lg border border-gray-100 bg-white bg-opacity-60 p-6 text-center text-gray-900 shadow backdrop-blur-sm hover:shadow-lg xl:p-8">
                        <h3 className="mb-4 text-2xl font-bold text-[#2C234D]">
            ...
            <div className="mt-16 h-full bg-gradient-to-r from-[#8c53fa] to-[#496adc] pt-10 text-white">
              <div className="grid grid-cols-1 justify-center lg:flex lg:p-20">
                <div className="mb-10 px-4 lg:mb-4 lg:px-20">
                  ...
                  <div>
                    <p className="mt-4 text-2xl">
                      Schedule a meeting to see if Ruby Finance is a good fit
                      your
                    </p>
                    <p className="text-2xl">business.</p>
                  </div>
